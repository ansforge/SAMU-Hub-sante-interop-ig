...
## ValueSet: Communication avec l'appelant (Hub Santé) 

| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/hubsante/ValueSet/vs-caller-communication | *Version*:0.1.0 |
| Draft as of 2026-03-17 | *Computable Name*:VSCallerCommunication |
...
```json
{
  ...
  "compose" : {
    "include" : [{
      "system" : "https://interop.esante.gouv.fr/ig/fhir/hubsante/CodeSystem/cs-caller-communication",
      "version" : "0.1.0"
    }]
  }
}
