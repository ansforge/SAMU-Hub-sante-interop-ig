...
## ValueSet: Rôles des opérateurs (Hub Santé) 

| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/hubsante/ValueSet/vs-operator-role | *Version*:0.1.0 |
| Draft as of 2026-03-17 | *Computable Name*:VSOperatorRole |
...
```json
{
  ...
  "id" : "vs-operator-role",
  "url" : "https://interop.esante.gouv.fr/ig/fhir/hubsante/ValueSet/vs-operator-role",
  "version" : "0.1.0",
  "name" : "VSOperatorRole",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://interop.esante.gouv.fr/ig/fhir/hubsante/CodeSystem/cs-operator-role",
      "version" : "0.1.0"
    }]
  }
}
