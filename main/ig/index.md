...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/hubsante/ImplementationGuide/ans.fhir.fr.hubsante | *Version*:0.1.0 |
| Draft as of 2026-03-17 | *Computable Name*:HubSante |
...
```json
{
  ...
  "id" : "ans.fhir.fr.hubsante",
  "url" : "https://interop.esante.gouv.fr/ig/fhir/hubsante/ImplementationGuide/ans.fhir.fr.hubsante",
  "version" : "0.1.0",
  "name" : "HubSante",
  "title" : "Hub Santé",
  "status" : "draft",
  ...
  "packageId" : "ans.fhir.fr.hubsante",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://interop.esante.gouv.fr/ig/fhir/hubsante/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/lm-main-diagnosis"
      },
      "name" : "Hypothèse de régulation médicale principale",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/lm-hypothesis"
      },
      "name" : "Hypothèses de régulation médicale",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/lm-other-diagnosis"
      },
      "name" : "Hypothèses de régulation médicale secondaires",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/lm-identity"
      },
      "name" : "Identité",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/vs-patient-care-level"
      },
      "name" : "Niveau de soin du patient (Hub Santé)",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CodeSystem/cs-patient-care-level"
      },
      "name" : "Niveau de soin du patient (Hub Santé)",
      "description" : "Niveaux de soins spécifiques au patient dans le contexte de la régulation médicale.",
      "exampleBoolean" : false
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/lm-patient"
      },
      "name" : "Patient",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/lm-detailed-name"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/vs-operator-role"
      },
      "name" : "Rôles des opérateurs (Hub Santé)",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CodeSystem/cs-operator-role"
      },
      "name" : "Rôles des opérateurs (Hub Santé)",
      "description" : "Rôles des professionnels de santé opérant au sein de l'entité émettrice d'un message Hub Santé.",
      "exampleBoolean" : false
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/vs-sex"
      },
      "name" : "Sexe du patient (Hub Santé)",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CodeSystem/cs-external-id-source"
      },
      "name" : "Source des identifiants externes patient (Hub Santé)",
      "description" : "Types d'identifiants externes utilisés pour identifier un patient.",
      "exampleBoolean" : false
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/lm-ins-strict-features"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/vs-contact-type"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CodeSystem/cs-contact-type"
      },
      "name" : "Type de contact (Hub Santé)",
      "description" : "Types d'URI utilisés pour les coordonnées de contact.",
      "exampleBoolean" : false
