...
## ValueSet: Type de contact (Hub Santé) 

| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/hubsante/ValueSet/vs-contact-type | *Version*:0.1.0 |
| Draft as of 2026-03-17 | *Computable Name*:VSContactType |
...
```json
{
  ...
  "id" : "vs-contact-type",
  "url" : "https://interop.esante.gouv.fr/ig/fhir/hubsante/ValueSet/vs-contact-type",
  "version" : "0.1.0",
  "name" : "VSContactType",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://interop.esante.gouv.fr/ig/fhir/hubsante/CodeSystem/cs-contact-type",
      "version" : "0.1.0"
    }]
  }
}
