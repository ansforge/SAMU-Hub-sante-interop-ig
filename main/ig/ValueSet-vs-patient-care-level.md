...
## ValueSet: Niveau de soin du patient (Hub Santé) 

| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/hubsante/ValueSet/vs-patient-care-level | *Version*:0.1.0 |
| Draft as of 2026-03-17 | *Computable Name*:VSPatientCareLevel |
...
```json
{
  ...
  "id" : "vs-patient-care-level",
  "url" : "https://interop.esante.gouv.fr/ig/fhir/hubsante/ValueSet/vs-patient-care-level",
  "version" : "0.1.0",
  "name" : "VSPatientCareLevel",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://interop.esante.gouv.fr/ig/fhir/hubsante/CodeSystem/cs-patient-care-level",
      "version" : "0.1.0"
    }]
  }
}
